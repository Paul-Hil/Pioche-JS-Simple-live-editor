...
var contenuHTML = document.querySelector("#contenu-html");
...
function handleLiveCode() {
    var inputUser = document.querySelector("#input-text").value;
    contenuHTML.innerHTML = inputUser;
}

// Appeler la fonction lors d'un événement 'keyup'. Si tout va bien… ça marche !

document.addEventListener("keyup", handleLiveCode);
